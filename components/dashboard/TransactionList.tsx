import { Car, CircleHelp, Fuel, ShoppingBag, ShoppingCart, UtensilsCrossed, WalletCards, Clapperboard } from 'lucide-react-native';
...
interface TransactionListProps { transactions: UpiTransaction[]; }
